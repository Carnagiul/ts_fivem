...
__export(Identity_exports, {
  ...
  identityLoaded: () => identityLoaded2,
...
// server/Class/Identity.ts
var tableName2 = "identities";
var identities = [];
var identityLoaded2 = false;
...
function addIdentity(firstName, lastName, height, weight, age, birthday, isMale, isFake) {
  const date = new Date();
  connection.query("INSERT INTO `" + tableName2 + "` (`firstName`, `lastName`, `height`, `weight`, `age`, `birthday`, `isMale`, `isFake`,  `created_at`,  `updated_at`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", [firstName, lastName, height, weight, age, birthday, isMale, isFake, date.toDateString(), date.toDateString()], (err, results) => {
    if (err)
      console.log(err);
    else {
      identities.push({
